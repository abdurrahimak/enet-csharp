...
{
    public class PacketOrganizer : IDisposable
    {
        ...
        internal PacketOrganizer(int _id)
        {
            buffer = new List<byte>(); // Intitialize buffer
            readPos = 0; // Set readPos to 0
        ...
        internal PacketOrganizer(byte[] _data)
        {
            buffer = new List<byte>(); // Intitialize buffer
            readPos = 0; // Set readPos to 0
        ...
        /// <param name="_data">The bytes to add to the packet.</param>
        internal void SetBytes(byte[] _data)
        {
            Write(_data);
